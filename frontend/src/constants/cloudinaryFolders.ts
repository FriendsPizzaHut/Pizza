 ...
 * @returns Cloudinary folder path
 */
export const getCloudinaryFolder = (type: ImageUploadType): string => {
    switch (type) {
        case 'product':
 ...
 */
export const getCloudinaryTransformation = (type: ImageUploadType) => {
    switch (type) {
        case 'product':
